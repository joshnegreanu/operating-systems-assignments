...
int main(int argc, char *argv[]) {
    ...
    while (1) {
        ...
        if (user_option_num == 1) {
            ...
            // get user input for the year to test
            ...
            // get a list of movies with that year using the helper function
            struct movie* movie_year_list = get_year_list(movie_list, input_year);

            // print specific info about the movies
            ...
            // get a list of top ranked movies per each year using the helper function
            ...
            // get the user input language to filter through movies
            ...
            // get a list of movies with support for that language using a helper function
